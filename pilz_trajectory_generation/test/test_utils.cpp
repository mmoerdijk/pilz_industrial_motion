                                                           ...
                                                           const double acc_tol)
{
  ...
  if(!std::is_sorted(accelerations.begin(), accelerations.end(), [acc_tol](double a, double b){
    return !(std::abs(a - b) < acc_tol || a < b); // true -> a is ordered before b -> list is not sorted
  }))
  {
